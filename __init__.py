...
try:
    from .nodes.API图片描述生成 import NODE_CLASS_MAPPINGS as API_DESCRIPTION_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as API_DESCRIPTION_NODE_DISPLAY_NAME_MAPPINGS
    API_DESCRIPTION_AVAILABLE = True
except ImportError as e:
    print(f"[NakuNode-Prompter] Warning: Could not import API Description Generator nodes: {e}")
    API_DESCRIPTION_NODE_CLASS_MAPPINGS = {}
    API_DESCRIPTION_NODE_DISPLAY_NAME_MAPPINGS = {}
    API_DESCRIPTION_AVAILABLE = False
...
NODE_CLASS_MAPPINGS.update(API_DESCRIPTION_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(API_DESCRIPTION_NODE_DISPLAY_NAME_MAPPINGS)
...
if API_DESCRIPTION_AVAILABLE:
    print(f"[NakuNode-Prompter] API Description Generator nodes available: {list(API_DESCRIPTION_NODE_CLASS_MAPPINGS.keys())}")