    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (nodeData.name === "NakuNodeTextEditor") {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                // 添加按钮小部件
                this.addWidget("button", "读取", null, this.loadData.bind(this));
            ...
            nodeType.prototype.openEditor = async function() {
                ...
                // 优先从UI返回的数据获取（这是后端传来的输入文本）
                if (this.widgets) {
                    for (let i = 0; i < this.widgets.length; i++) {
                        const widget = this.widgets[i];
                        if (widget.name === "current_text") {
            ...
            nodeType.prototype.createEditorPopup = function(originalText) {
                ...
                editorContainer.style.backgroundColor = '#36393F';
                ...
                info.textContent = '上方文本框：显示原始文本（只读，与输入完全一致）| 下方文本框：编辑文本（可编辑）';
                ...
                readOnlyTextArea.style.backgroundColor = '#2F3136';
                ...
                readOnlyTextArea.style.whiteSpace = 'pre-wrap';
                readOnlyTextArea.style.overflow = 'auto';
                ...
                editableTextArea.style.backgroundColor = '#202225';
                ...
                editableTextArea.style.whiteSpace = 'pre-wrap';
                editableTextArea.style.overflow = 'auto';
                ...
                completeButton.style.backgroundColor = '#43B581';
                ...
                completeButton.onclick = async () => {
                    ...
                    // 保存编辑后的文本到后端
                    const success = await this.applyEditedText(newText);
                    ...
                    if (success) {
                        ...
                        this.properties.current_text = newText;
                    ...
                    try {
                        ...
                        console.error("执行后续工作流时出错:", error);
                    }
                };
